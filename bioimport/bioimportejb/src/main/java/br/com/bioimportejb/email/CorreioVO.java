...
public class CorreioVO implements Serializable{
	...
	private Boolean flagEnviarEmail = false;
	...
	public Boolean getFlagEnviarEmail() {
		return flagEnviarEmail;
	}
	public void setFlagEnviarEmail(Boolean flagEnviarEmail) {
		this.flagEnviarEmail = flagEnviarEmail;
	}
